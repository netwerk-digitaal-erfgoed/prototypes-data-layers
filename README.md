...
Find the heritage objects that match the term with ID `http://localhost:3000/v1/terms/a5b066b96fac9f0e71534f1a7811a24a` (name: "natuurlijke historie") regardless of field ("\*"):
